...
namespace ActionCode.Persistence
{
    ...
    public static class CompressorFactory
    {
        ...
        public static ICompressor Create(CompressorType type) => Create(type, StreamFactory.Create());
        ...
        public static ICompressor Create(CompressorType type, IStream stream) => type switch
        {
